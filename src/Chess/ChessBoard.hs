...
chessBoardAsString chessBoard = "\n*--*--* Current Chess Board *--*--*\n\n"
                        ...
                        ++ "(A)  "  ++ retrievePieceAt ('A',1) chessBoard
                                    ...
                                    ++ retrievePieceAt ('A',3) chessBoard 
                                    ++ retrievePieceAt ('A',4) chessBoard 
                                    ++ retrievePieceAt ('A',5) chessBoard 
                                    ++ retrievePieceAt ('A',6) chessBoard 
                                    ++ retrievePieceAt ('A',7) chessBoard 
                                    ++ retrievePieceAt ('A',8) chessBoard 
                        ++ "\n" 
                        ++ "(B)  "  ++ retrievePieceAt ('B',1) chessBoard
                        ...
                        ++ "\n"
                        ++ "(C)  "  ++ retrievePieceAt ('C',1) chessBoard
                        ...
                        ++ "\n"
                        ++ "(D)  "  ++ retrievePieceAt ('D',1) chessBoard
                        ...
                        ++ "\n"
                        ++ "(E)  "  ++ retrievePieceAt ('E',1) chessBoard
                        ...
                        ++ "\n"
                        ++ "(F)  "  ++ retrievePieceAt ('F',1) chessBoard
                        ...
                        ++ "\n"
                        ++ "(G)  "  ++ retrievePieceAt ('G',1) chessBoard
                        ...
                        ++ "\n"
                        ++ "(H)  "  ++ retrievePieceAt ('H',1) chessBoard
