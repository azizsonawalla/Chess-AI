...
-- TODO: Implement + test this (moves for King at the given position) (1.5 hours)
...
-- TODO: Implement + test this (moves for Queen at the given position) (1 hour)
...
-- TODO: Implement + test this (moves for Rook at the given position) (2 hour)
...
-- TODO: Implement + test this (moves for Bishop at the given position) (2 hour)
...
-- TODO: Implement + test this (moves for Knight at the given position) (1.5 hour)
...
-- TODO: Implement + test this (moves for Pawn at the given position) (1.5 hour)
...
buildMoves startPosition endPositions = []